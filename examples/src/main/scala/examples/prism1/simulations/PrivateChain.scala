package examples.prism1.simulations
...
import examples.prism1.mining.{HybridSettings, PosForger, PowMiner}
import examples.prism1.state.HBoxStoredState
import examples.prism1.util.FileFunctions
...
object PrivateChain extends App with ScorexLogging with ScorexEncoding {
  ...
  def genesisState(): (HybridHistory, HBoxStoredState, HBoxWallet, SimpleBoxTransactionPrismMemPool)  = {
