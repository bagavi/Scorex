...
import examples.prism1.mining.WalletSettings
...
case class HBoxWallet(seed: Array[Byte], store: LSMStore)
  extends BoxWallet[PublicKey25519Proposition, SimpleBoxTransactionPrism, HybridBlock, HBoxWallet]
  ...
  override def historyTransactions: Seq[BoxWalletTransaction[PublicKey25519Proposition, SimpleBoxTransactionPrism]] = ???
  ...
  override def scanOffchain(tx: SimpleBoxTransactionPrism): HBoxWallet = this

  override def scanOffchain(txs: Seq[SimpleBoxTransactionPrism]): HBoxWallet = this
